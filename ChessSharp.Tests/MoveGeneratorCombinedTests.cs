...
{
    public class MoveGeneratorCombinedTests : IClassFixture<MoveGeneratorFixture>
    {
        MoveGeneratorFixture _moveGeneratorFixture;

        public MoveGeneratorCombinedTests(MoveGeneratorFixture moveGeneratorFixture)
        {
        ...
        //    var pinnedPieces = _moveGeneratorFixture.MoveGenerator.GetPinnedSquares(relativeBitBoard, moves);
        ...
        //{
        //    var relativeBitBoard = Create("8/8/8/8/8/3p4/4P3/8 w KQkq -");
        ...
        //{
        //    var relativeBitBoard = Create("8/2b5/3P4/4K3/8/8/8/7k w KQkq -");
        ...
        //    _moveGeneratorFixture.MoveGenerator.AddRookMoves(relativeBitBoard, SquareFlagConstants.All, SquareFlagConstants.All, 0, moves);
        ...
        //    _moveGeneratorFixture.MoveGenerator.AddBishopMoves(relativeBitBoard, SquareFlagConstants.All, SquareFlagConstants.All, 0, moves);
        ...
        public void Queen_A1_H8_0Captures_Correct(string fen, int moveCount)
        {
            ...
            _moveGeneratorFixture.MoveGenerator.AddQueenMoves(relativeBitBoard, SquareFlagConstants.All, SquareFlagConstants.All, 0, moves);
        ...
        //[Fact]
        //public void Generate_King_Check_Evade_Correct()
        //{
        ...
        //[Fact]
        //public void Generate_King_DoubleCheck_Evade_Correct()
        //{
        ...
        //[Fact]
        //public void Generate_King_DiscoverCheck_Correct()
        //{
        ...
        [Fact]
        public void Generate_Castle_Both_Correct()
        {
        ...
        [InlineData("6p1", 0, 1)]
        [InlineData("7p", 0, 1)]
        public void Generate_Castle_BlockedByPassingThroughCheck_Correct(string partialFen, int castleKingExpectedCount, int castleQueenExpectedCount)
        {
